...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    private UserClientProtocolRequestProcesser userClientProtocolRequestProcesser;


    public NettyServerHandler() {
        this.userClientProtocolRequestProcesser = SpringContextHolder.getBean(UserClientProtocolRequestProcesser.class);
    }
    /**
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        userClientProtocolRequestProcesser.process(ctx,ms);
      //  serviceNettyServer.channeRead(ctx,msg);
        /**
